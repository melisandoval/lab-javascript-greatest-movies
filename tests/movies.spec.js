...
describe('Function "orderByYear"', () => {
  ...
  /* changed the above tests, before it was:
     expect(
      orderByYear([{ year: 2002 }, { year: 1982 }, { year: 1995 }])
    ).toEqual([{ year: 1982 }, { year: 1995 }, { year: 2002 }]);

    Because with this object that doesn't have the key "title" I was having undefined
    for the value of that property in the function and this test failed
*/
